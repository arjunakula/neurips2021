...
if __name__ == '__main__':
  ...
  args.checkpoint_path = data_dir + "/run_fixedPG+EE_ref_singleObject_small/execution_engine_with_CL_extension_for_without_NTM_EntireQuestion_CL_annealing_10_to_5.pt"
