...
def train_loop(args, train_loader, train_len, val_loader, val_len):
  ...
  linear_iterations = [2,2,2,2,2,2,2,2,2,3,3,3,3,5,5] # CL_extension_for_AttnEntireQuestion_CL_3_epochs
...
if __name__ == '__main__':
  ...
  args.num_iterations = 450000
  args.learning_rate = 1e-4
  args.checkpoint_path = data_dir + "/run_fixedPG+EE_ref_singleObject_small/execution_engine_with_CL_extension_for_without_NTM_EntireQuestion_CL_3_epochs_full.pt"
  args.checkpoint_every_epoch = 1
  args.train_refexp_h5 = data_dir +  "/train_refexps.h5"
  args.train_features_h5 = data_dir +  "/train_features.h5"
  args.val_refexp_h5 = data_dir +  "/val_refexps.h5"
