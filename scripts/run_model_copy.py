...
parser.add_argument('--result_output_path', default = './data/result.json', type=str)
parser.add_argument('--program_generator', default='data/backup_models/baseline_18k_single_object_largeBatchSize/program_generator.pt_32000')
parser.add_argument('--execution_engine', default='data/run_fixedPG+EE_ref_singleObject_small/execution_engine_with_LSTMEncoderAttn_lang_attention_with_entire_question_lstm.pt_150000')
parser.add_argument('--baseline_model', default=None)
parser.add_argument('--use_gpu', default=1, type=int)

# For running on a preprocessed dataset
parser.add_argument('--input_refexp_h5', default='data/val_refexps_singleObject.h5')
...
def run_our_model_batch(args, program_generator, execution_engine, loader, dtype):
  ...
  for batch in loader:
    ...
    if(path.exists('/home/arjunakula/Dropbox/My_UCLA_docs_from_2016_sept/PhD_Research/after_summer_2019/EMNLP2020_Mila_mygithub/emnlp_CL_extension/evaluation/neurips2021/feats.pkl')):
      fp = open("/home/arjunakula/Dropbox/My_UCLA_docs_from_2016_sept/PhD_Research/after_summer_2019/EMNLP2020_Mila_mygithub/emnlp_CL_extension/evaluation/neurips2021/feats.pkl","rb")
      store_vis = pickle.load(fp)
      fp.close()
      fp = open("/home/arjunakula/Dropbox/My_UCLA_docs_from_2016_sept/PhD_Research/after_summer_2019/EMNLP2020_Mila_mygithub/emnlp_CL_extension/evaluation/neurips2021/feats.pkl","wb")
      store_vis.append({'feats':feats[0], 'image_path':'data/clevr_ref+_1.0/images/val/CLEVR_val_'+str(image_id[0].item()).zfill(6)+'.png'})
      pickle.dump(store_vis,fp)
      fp.close()
    else:
      fp = open("/home/arjunakula/Dropbox/My_UCLA_docs_from_2016_sept/PhD_Research/after_summer_2019/EMNLP2020_Mila_mygithub/emnlp_CL_extension/evaluation/neurips2021/feats.pkl","wb")
      pickle.dump([{'feats':feats[0], 'image_path':'data/clevr_ref+_1.0/images/val/CLEVR_val_'+str(image_id[0].item()).zfill(6)+'.png'}], fp)
      fp.close()
